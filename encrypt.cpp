/*	Programmer: Jeffrey Guzman
	...
	Description: This Program encrypts a 4-digit number as follows:
					1. Seperate the digits using / and %
					2. Add 7 to each digit and % with 
					3. Swap the 1st digit with the 3rd and 2nd digit
						with the 4th.
					4. Display the encrypted number.
*/
#include <iostream>
using namespace std;
...
int main()
{
	...
	cout << "The encrypted number is: " << d1 * 1000 + d2 * 100 + d3 * 10 + d4 * 1 << endl;
